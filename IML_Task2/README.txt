...
IMPORTANT: to be able to run the script, the files included in the task description (test_features.csv, train_features.csv, train_labels.csv) MUST be copied in THE SAME folder ie in Task2/scripts. (we could not include them due to their great size)
